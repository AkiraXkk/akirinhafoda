...
const comandosPorArea = {
  divulgacao: {
    nome: "Divulgação", emoji: "🗞️", cor: "#ff4d4d", cargo: "Equipe Divulgação",
    comandos: [
  ...
  movcall: {
    nome: "MovCall", emoji: "🎙️", cor: "#3498db", cargo: "Equipe MovCall",
    comandos: [
  ...
  movchat: {
    nome: "MovChat", emoji: "🗣️", cor: "#00d2d3", cargo: "Equipe MovChat",
    comandos: [
  ...
  acolhimento: {
    nome: "Acolhimento", emoji: "🫂", cor: "#f1c40f", cargo: "Equipe Acolhimento",
    comandos: [
  ...
  recrutamento: {
    nome: "Recrutamento", emoji: "🫡", cor: "#ff9ff3", cargo: "Equipe Recrutamento",
    comandos: [
...
module.exports = {
  ...
  async execute(interaction) {
    const embedPrincipal = new EmbedBuilder()
      .setTitle("📚 Central de Ajuda da Staff WDA")
      .setColor("#5865F2")
      .setDescription("Selecione no menu abaixo a sua área de atuação para visualizar a lista de ferramentas e comandos disponíveis para você.")
      .setFooter({ text: "O acesso é restrito apenas aos membros de cada área." });
    ...
    collector.on("collect", async (i) => {
      ...
      // Constrói a aba de ajuda da área selecionada
      const embedAjuda = new EmbedBuilder()
        .setTitle(`${areaData.emoji} Manual: ${areaData.cargo}`)
        .setColor(areaData.cor)
        .setDescription(`Abaixo estão todos os comandos disponíveis para facilitar o seu trabalho na equipe de **${areaData.nome}** da WDA:\n\n` + areaData.comandos.join("\n\n"));
